...
/**
 * Class AddFriendRequestResultType
 * @package Speedfreak\Entities\Social
 * @Serializer\XmlRoot(name="AddFriendRequestResultType")
 */
class AddFriendRequestResultType
{
    /**
     ...
     */
    public function getFriendPersona()
    {
     ...
     */
    public function setFriendPersona($friendPersona)
    {
